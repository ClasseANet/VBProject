...
Begin VB.Form FrmPaneSupri 
   ...
   Begin MSComctlLib.ImageList imlTaskPanelIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":0452
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":12B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":1850
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":1BEA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmPaneSupri.frx":1F84
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin XtremeSuiteControls.GroupBox FraFiltro 
      ...
      BorderStyle     =   2
      Begin XtremeSuiteControls.ComboBox CmbPeriodo 
         Height          =   315
         Left            =   120
         TabIndex        =   5
         Top             =   480
   ...
   End
End
Attribute VB_Name = "FrmPaneSupri"
...
Event Load()
Event Resize()
Event CmbPeriodoClick()
Event KeyPress(KeyAscii As Integer)
Event KeyUp(KeyCode As Integer, Shift As Integer)
Event CommandBarsExecute(ByVal Control As XtremeCommandBars.ICommandBarControl)
Event Scctit2MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
...
Private Sub Form_Resize()
   RaiseEvent Resize
End Sub
Private Sub Scctit2_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
   RaiseEvent Scctit2MouseDown(Button, Shift, x, y)
End Sub
