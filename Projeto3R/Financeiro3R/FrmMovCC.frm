...
Object = "{7CAC59E5-B703-4CCF-B326-8B956D962F27}#11.2#0"; "CODEJO~3.OCX"
Object = "{A8E5842E-102B-4289-9D57-3B3F5B5E15D3}#11.2#0"; "CODEJO~1.OCX"
Object = "{831FDD16-0C5C-11D2-A9FC-0000F8754DA1}#2.1#0"; "MSCOMCTL.OCX"
Begin VB.Form FrmMovCC 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   Caption         =   "Conta"
   ClientHeight    =   6195
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMovCC.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmMovCC.frx":0452
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Event TxtVALORKeyDown(KeyCode As Integer, Shift As Integer)
Event TxtValorKeyPress(KeyAscii As Integer)
Event TxtValorKeyUp(KeyCode As Integer, Shift As Integer)
...
Private Sub TxtVALOR_KeyDown(KeyCode As Integer, Shift As Integer)
   RaiseEvent TxtVALORKeyDown(KeyCode, Shift)
End Sub
Private Sub TxtValor_KeyPress(KeyAscii As Integer)
   RaiseEvent TxtValorKeyPress(KeyAscii)
End Sub
Private Sub TxtValor_KeyUp(KeyCode As Integer, Shift As Integer)
   RaiseEvent TxtValorKeyUp(KeyCode, Shift)
End Sub
