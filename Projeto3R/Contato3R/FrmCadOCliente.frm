...
Begin VB.Form FrmCadOCliente 
   ...
   Begin XtremeSuiteControls.PushButton CmdExcluir 
      ...
      ForeColor       =   64
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmCadOCliente.frx":0000
   End
   ...
   Begin XtremeSuiteControls.PushButton CmdNovo 
      ...
      ForeColor       =   12582912
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmCadOCliente.frx":0ACA
   End
   Begin XtremeSuiteControls.PushButton CmdSalvar 
      ...
      ForeColor       =   32768
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmCadOCliente.frx":0E64
   End
   ...
   Begin XtremeSuiteControls.PushButton cmdLov 
      ...
      _StockProps     =   79
      UseVisualStyle  =   -1  'True
      Picture         =   "FrmCadOCliente.frx":272E
   End
   ...
   Begin XtremeSuiteControls.PushButton CmdExpHis 
      ...
      TextAlignment   =   8
      Appearance      =   2
      Picture         =   "FrmCadOCliente.frx":28B1
      TextImageRelation=   0
   End
   Begin XtremeSuiteControls.GroupBox GrpSessao 
      ...
      Begin XtremeSuiteControls.PushButton CmdNovoItem 
         ...
         ForeColor       =   12582912
         UseVisualStyle  =   -1  'True
         Picture         =   "FrmCadOCliente.frx":2C4B
      End
   ...
   Begin MSComctlLib.ImageList ImgFatura 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCadOCliente.frx":2FE5
            Key             =   "K1"
            Object.Tag             =   "1"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCadOCliente.frx":313F
            Key             =   "K2"
            Object.Tag             =   "2"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCadOCliente.frx":3789
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCadOCliente.frx":38E3
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmCadOCliente.frx":3C7D
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmCadOCliente"
...
Event GrdSessaoMouseDown(ByVal Button As Integer, Shift As Integer, ByVal x As Single, ByVal y As Single, ByVal lRow As Long, ByVal lCol As Long, bDoDefault As Boolean, ByVal bUnderControl As Boolean)
Event GrdSessaoMouseEnter(ByVal lRow As Long, ByVal lCol As Long)
...
End Sub
Private Sub GrdSessao_MouseDown(ByVal Button As Integer, Shift As Integer, ByVal x As Single, ByVal y As Single, ByVal lRow As Long, ByVal lCol As Long, bDoDefault As Boolean, ByVal bUnderControl As Boolean)
   RaiseEvent GrdSessaoMouseDown(Button, Shift, x, y, lRow, lCol, bDoDefault, bUnderControl)
End Sub
Private Sub GrdSessao_MouseEnter(ByVal lRow As Long, ByVal lCol As Long)
   RaiseEvent GrdSessaoMouseEnter(lRow, lCol)
End Sub
