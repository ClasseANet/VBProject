...
UPDATE VERSAOBD SET VSBD='1.0', DTATU=GetDate(), ATUBD='46', ARQATU='Rev46.sql';
/****************************************************************************
****************************************************************************/
...
GO
UPDATE FCCORRENTE SET IDCOLIGADA=(SELECT MIN(IDCOLIGADA) FROM OLOJA)
GO
IF  NOT EXISTS (SELECT * FROM GRPUSU WHERE IDGRUPO='MASTER') INSERT INTO GRPUSU (IDGRUPO, DSCGRUPO) VALUES ('MASTER','Acesso Gerencial');
GO
IF  NOT EXISTS (SELECT * FROM GRPUSU WHERE IDGRUPO='LOJA') INSERT INTO GRPUSU (IDGRUPO, DSCGRUPO) VALUES ('LOJA','Acesso Loja');
GO
IF  NOT EXISTS (SELECT * FROM GRPUSU_SISTEMA WHERE IDGRUPO='MASTER') INSERT INTO GRPUSU_SISTEMA (CODSIS, IDGRUPO) VALUES ('P3R','MASTER');
GO
IF  NOT EXISTS (SELECT * FROM GRPUSU_SISTEMA WHERE IDGRUPO='LOJA') INSERT INTO GRPUSU_SISTEMA (CODSIS, IDGRUPO) VALUES ('P3R','LOJA');
GO
If Not Exists(Select * from FDESPESA Where IDLOJA=1 And IDDESP=0) INSERT INTO FDESPESA (IDLOJA,IDDESP,DSCDESP,CODDESP,IDPAI,IDGRPDESP,ATIVO,OCULTO,TPDESP) VALUES (1,0,'','',0,0,1,1,1)
GO
If Not Exists(Select * from FDESPESA Where IDLOJA=1 And IDDESP=1) INSERT INTO FDESPESA (IDLOJA,IDDESP,DSCDESP,CODDESP,IDPAI,IDGRPDESP,ATIVO,OCULTO,TPDESP) VALUES (1,1,'Vendas','1',0,0,1,0,1)
GO
DELETE FROM PARAM WHERE IDLOJA=0
GO
UPDATE DELETEDROWS SET ALTERSTAMP=1
GO