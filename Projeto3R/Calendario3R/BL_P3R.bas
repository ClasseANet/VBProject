...
Public Function DefineContaLAN(ByRef pTbConta As Object, pIDFORMAPGTO As Long, pSys As Object) As Boolean
   ...
   End With
End Function
Public Function ExisteLstItem(pLst As Object, pKey As String) As Boolean
...
TrataErro:
   ...
   Resume Next
End Sub
Public Sub SetCustomIcons2(ByRef pEvent As Object)  'XtremeCalendarControl.CalendarEvent)
   ...
   With pEvent
      ...
      If .PrivateFlag Then .CustomIcons.Add -5 'xtpCalendarEventIconIDPrivate
      If .Reminder Then .CustomIcons.Add -1 'xtpCalendarEventIconIDReminder
      If .MeetingFlag Then .CustomIcons.Add -4 ' xtpCalendarEventIconIDMeeting
      If .RecurrenceState = 2 Then 'xtpCalendarRecurrenceOccurrence Then
         .CustomIcons.Add -2 'xtpCalendarEventIconIDOccurrence
      End If
      If .RecurrenceState = 3 Then 'xtpCalendarRecurrenceException Then
         .CustomIcons.Add -3 'xtpCalendarEventIconIDException
      End If
...
Public Sub SetEventFlag2(ByRef pEvent As Object, Optional pRs As Object)   'Optional pIDEVENTO, Optional pIDATEND)
...
End Sub
Public Function Sql_OATENDIMENTO(pIDLOJA As Integer, Optional pIDATEND, Optional pIDCLIENTE, Optional pIDEVENTO) As String
   Dim Sql As String
   Sql = "Select *" & vbNewLine
   Sql = Sql & " From OATENDIMENTO" & vbNewLine
   Sql = Sql & " Where IDLOJA=" & pIDLOJA & vbNewLine
   If Not IsMissing(pIDATEND) Then Sql = Sql & " And IDATENDIMENTO=" & pIDATEND & vbNewLine
