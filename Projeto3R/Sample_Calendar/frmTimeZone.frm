...
Private Sub cmdOk_Click()
  On Error Resume Next
    'CalendarControl.DayView.ScaleText = txtLabel.Text
    'CalendarControl.DayView.Scale2Text = txtLabel2.Text
    CalendarControl.Options.DayViewScaleLabel = txtLabel.Text
    CalendarControl.Options.DayViewScale2Label = txtLabel2.Text
    
    If chkShowAdditionalTimeZone.Value = 0 Then
        'CalendarControl.DayView.Scale2Visible = False
        CalendarControl.Options.DayViewScale2Visible = False
    Else
        'CalendarControl.DayView.Scale2Visible = True
        CalendarControl.Options.DayViewScale2Visible = True
    End If
    ...
    'CalendarControl.DayView.SetScale2TimeZone tziScale2
    CalendarControl.Options.SetScale2TimeZone tziScale2
...
Private Sub Form_Load()
  On Error Resume Next
    ...
    Set tziCurrent = CalendarControl.Options.GetCurrentTimeZone
    Set tzi2 = CalendarControl.Options.GetScale2TimeZone
    Set g_pTimeZones = CalendarControl.Options.EnumAllTimeZones
    bIsScale2Visible = CalendarControl.Options.DayViewScale2Visible
        
    txtLabel.Text = CalendarControl.Options.DayViewScaleLabel
    txtLabel2.Text = CalendarControl.Options.DayViewScale2Label
